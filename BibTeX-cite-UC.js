{
  "translatorID": "9cb70025-a888-4a29-a210-93ec5citeMTS",
	"translatorType": 3,
	"label": "BibTeX-cite-UC",
	"creator": "Vladislav Ivanistsev - from Peter O'Brien, Simon Kornblith and Richard Karnesky",
	"target": "bib",
	"minVersion": "2.1.9",
	"maxVersion": null,
	"priority": 200,
	...
	"lastUpdated": "2013-06-04 10:15:34"
}
...
function titleHash (input_title) {
	var title = tidyAccents(input_title);
	...
	var title_hash3 = 'a'.charCodeAt(0) + (crc_title % 25)
	var title_hash = String.fromCharCode(title_hash1) + String.fromCharCode(title_hash2) + String.fromCharCode(title_hash3);
	return title_hash;
}
...
function doExport() {
	...
	while(item = Zotero.nextItem()) {
		...
		// write citation key
		Zotero.write((first ? "\\cite{" : ",") + citekey);
		first = false;
